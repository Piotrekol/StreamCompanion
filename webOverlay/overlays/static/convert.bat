...
fart.exe -r -c -C -- .\* "CreateProxiedReconnectingWebSocket" "CreateProxiedReconnectingWebSocket"
fart.exe -r -c -C -- .\* "${window.overlay.config.port}" "${window.overlay.config.port}"
fart.exe -r -c -C -- .\* "${window.overlay.config.host}" "${window.overlay.config.host}"
